...
> **注意区分**：本文件管的是**设计文档版本**（`V1`/`V2`，按设计变更升号）。
> **plugin / skill pack 发版版本**（`v0.1`/`v1.0`/`v1.1`，semver）记录在 `CHANGELOG.md`，与本文件无关。
> v1.1（codename `flow-restructure`，含 BREAKING）详见 `CHANGELOG.md` 顶部条目。
