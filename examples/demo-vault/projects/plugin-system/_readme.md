...
relations:
  supports:
    - "[[goals/learn-plugin-design/_readme|learn-plugin-design]]"
  contradicts: []
  evolves: []
  supersedes:
    - "[[projects/bi-engine/_readme|bi-engine（已归档）]]"
...
为公司内部工具设计第二代插件系统。前代（[[projects/bi-engine|BI 引擎]]）于 2024 因沙箱逃逸事故归档。本项目目标：
...
- [[areas/ai-engineering/agent-tool-use|agent-tool-use concept]]
- [[areas/ai-engineering/rag-architecture|rag-architecture concept]]
