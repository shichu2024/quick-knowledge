...
> 本 MOC 汇集所有关于扩展系统隔离设计的笔记。本主题是 [[projects/plugin-system|插件系统 v2 项目]] 的核心知识支撑。
...
- [[projects/bi-engine/decisions/2024-02-isolation-choice|BI 引擎 Decision 001]] · archived · 派生 experience

## 项目

- [[projects/bi-engine/_readme|BI 引擎]]（已归档，2024）
- [[projects/plugin-system/_readme|插件系统 v2]]（active）

## 目标

- [[goals/learn-plugin-design/_readme|学习插件系统设计]]
