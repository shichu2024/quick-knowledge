...
value:
  ...
  uniqueness: 5
source:
  - note: "[[projects/bi-engine/decisions/2024-02-isolation-choice]]"
derived_from: "[[projects/bi-engine/decisions/2024-02-isolation-choice]]"
...
- 2024-07：紧急回滚插件机制，3 周后改用进程级隔离（[[projects/bi-engine]] archive）
...
> 派生自 [[projects/bi-engine/decisions/2024-02-isolation-choice]] 的 lesson 字段
...
- [x] 下次插件系统选型时是否复用此教训？（[[projects/plugin-system]] 已复用）
